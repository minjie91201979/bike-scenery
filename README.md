...
- **17 国场景**：中国、俄罗斯、日本、美国、澳大利亚、埃及、印度、加拿大、法国、巴西、墨西哥、英国、韩国、意大利、土耳其、沙特阿拉伯、南非。各国独立闭环、色板、地标简模；部分岛国有左侧海岸与渔船。土耳其另有远近分层的卡帕多奇亚热气球（球囊花纹 / 燃烧器 / 吊篮 / 绳索附件）。闭环公路在缓丘之上另叠若干可感知的上下坡段（约 80～160 m 一段），下坡会略加速、上坡略减速，刹停后不会自己溜走。
...
- **路边店铺**：路肩投放 `public/assets/models/*_shop.glb`（中国茶馆、日本拉面、法国咖啡馆等）；无专模的国家就近借用。体积约放大一倍，贴地并避开景点与湖岸。
